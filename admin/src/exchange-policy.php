...
error_reporting(0);
$id = $_GET['id'];
$eQuery = "SELECT * FROM `exchange_policy`";
...
if (isset($_POST['save'])) {
 ...
 //   Banner Image UPLOAD
  ...
  if(!empty($img)){
    $sql = "UPDATE `exchange_policy` SET `img`='$img', `content`='$content'";
  }else{
   $sql = "UPDATE `exchange_policy` SET `content`='$content'";
  }
  ...
  if ($query) {
    echo "<script>
    window.location.href='exchange-policy.php';
    </script>";
  } else {
        ...
        <div class="row g-0">
          ...
          <div class="col-auto mb-3 mb-md-0 me-auto">
            <div>
              ...
              <h1 class="mb-0 pb-0 display-4" id="title">Edit Exchange Policy</h1>
            </div>
          </div>
          <!-- Title End -->
