...
error_reporting(0);
$id = $_GET['id'];
$eQuery = "SELECT * FROM `information`";
...
if (isset($_POST['save'])) {
    ...
    if (!empty($img)) {
        $sql = "UPDATE `information` SET `img`='$img', `content`='$content'";
    } else {
        $sql = "UPDATE `information` SET `content`='$content' ";
    }
    ...
    if ($query) {
        echo "<script>
    window.location.href='info_edit.php';
    </script>";
    } else {
                ...
                <div class="row g-0">
                    ...
                    <div class="col-auto mb-3 mb-md-0 me-auto">
                        <div>
                            ...
                            <h1 class="mb-0 pb-0 display-4" id="title">Edit Terms and Conditon</h1>
                        </div>
                    </div>
                    <!-- Title End -->
