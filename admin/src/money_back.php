...
if (isset($_POST['save'])) {
 ...
 //   Banner Image UPLOAD
  ...
  if(!empty($img)){
    $sql = "UPDATE `money_back` SET `img`='$img', `content`='$content'";
  }else{
   $sql = "UPDATE `money_back` SET `content`='$content'";
  }
  ...
  if ($query) {
    echo "<script>
    window.location.href='money_back.php';
    </script>";
  } else {
        ...
        <div class="row g-0">
          ...
          <div class="col-auto mb-3 mb-md-0 me-auto">
            <div>
              ...
              <h1 class="mb-0 pb-0 display-4" id="title">Edit Money Back</h1>
            </div>
          </div>
          <!-- Title End -->
