...
if (isset($_POST['save'])) {
 ...
 //   Banner Image UPLOAD
  ...
  if(!empty($img)){
    $sql = "UPDATE `shipping` SET `img`='$img', `content`='$content'";
  }else{
   $sql = "UPDATE `shipping` SET `content`='$content'";
  }
        ...
        <div class="row g-0">
          ...
          <div class="col-auto mb-3 mb-md-0 me-auto">
            <div>
              ...
              <h1 class="mb-0 pb-0 display-4" id="title">Edit Shipping</h1>
            </div>
          </div>
          <!-- Title End -->
