...
error_reporting(0);
$id = $_GET['id'];
$eQuery = "SELECT * FROM `support_center`";
...
if (isset($_POST['save'])) {
 ...
 //   Banner Image UPLOAD
  ...
  if(!empty($img)){
    $sql = "UPDATE `support_center` SET `img`='$img', `content`='$content'";
  }else{
   $sql = "UPDATE `support_center` SET `content`='$content'";
  }
        ...
        <div class="row g-0">
          ...
          <div class="col-auto mb-3 mb-md-0 me-auto">
            <div>
              ...
              <h1 class="mb-0 pb-0 display-4" id="title">Edit Support Center</h1>
            </div>
          </div>
          <!-- Title End -->
