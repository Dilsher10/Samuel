                        ...
                        <div class="sticky-sidebar">
                            ...
                            <div class="widget widget-collapsible">
                                ...
                                <div class="widget-body">
                                    ...
                                    <form class="price-range" action="search.php" method="POST">
                ...
                <div class="main-content">
                    ...
                    <div class="product-wrapper row cols-md-3 cols-sm-2 cols-2">
                       ...
                       if (isset($_REQUEST['filter'])) {
                        ...
                        $search_sql =  "SELECT * FROM products_detail where $from  order by regular_price";
                      } elseif (!isset($_POST['search']))
                    
                      $_POST['search'] = mysqli_real_escape_string($conn, $_POST['search']);
                      $search_sql = "SELECT * FROM `products_detail` WHERE `category` LIKE '%" . $_POST['search'] . "%' OR `title` LIKE '%" . $_POST['search'] . "%' AND status = 'Approved'";
                                        ...
                                        <div class="product text-center">
                                            ...
                                            <div class="product-details">
                                               ...
                                               if(!empty($row['sale_price']) || !empty($price_data['small_sale_price'])){
                                                ?>
                                                  <ins class="new-price">$<?= $row['sale_price'];?> <?= $price_data['small_sale_price'];?></ins>
                                                <?php
                                               }
                                               
                                               if(!empty($row['regular_price']) || !empty($price_data['small_regular_price'])){
                                                ?>
                                                  <del class="old-price">$<?= $row['regular_price'] ?> <?= $price_data['small_regular_price'];?></del>
                                                <?php
                                               }
                                            ?>
                                                    </div>
