...
if (isset($_POST['forgot_btn'])) {
    $email = $_POST['email'];
    $sqlQuery = "SELECT * FROM `user_registration` WHERE email_address = '$email' ";
    ...
    if ($emailcount) {
        ...
        $body = "Hi, $username. click here to reset your password https://parcelprevail.com/vendor_dashboard/src/reset_password.php?token=$token";
        ...
        <div class="card rounded-3 text-black">
          <div class="card-body p-md-5 mx-md-4">
                ...
                <form method="POST">
                  ...
                  <a href="/vendor_dashboard/src/login.php" class="backLink"><img src="img/left-arrows.png" alt="" class="img-fluid"> Go to Log in</a>
                </form>
              </div>
        </div>
      </div>
