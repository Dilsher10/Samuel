...
if (isset($_POST['reset_btn'])) {
    ...
    $sqlQuery = "UPDATE `user_registration` SET `password`='$newpassword' WHERE token = '$token' ";
   ...
   <div class="card-body p-md-5 mx-md-4">
                ...
                <form method="POST">
                  ...
                  <div class="text-center pt-1 mb-5 pb-1">
                    <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" type="submit" name="reset_btn">Reset Password</button>
                  </div>
