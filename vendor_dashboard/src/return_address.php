...
if (isset($_POST['save'])) {
  ...
  $email = $_POST['email'];
    ...
    $sql = "INSERT INTO return_address (first_name,last_name,address,phone,country,state,email,token) VALUES ('" . $f_name . "','" .  $l_name . "','" . $address . "','" .  $phone . "','" . $country . "','" . $state . "','" . $email . "','" .  $_SESSION['token'] . "')";
          ...
          <div class="page-title-container">
            <div class="row g-0">
              ...
              <div class="col-auto mb-3 mb-md-0 me-auto">
                <div>
                  <h1 class="mb-0 pb-0 display-4" id="title">Add Return Address Info</h1>
                </div>
              </div>
              <!-- Title End -->
              ...
              <div class="col col-md-auto d-flex align-items-end justify-content-end">
                <button name="save" type="submit" class="btn btn-outline-primary btn-icon btn-icon-start w-100" onclick="validateEmail(event)">
                ...
                <div class="card">
                  ...
                  <div class="row">
                    ...
                    <div class="mb-5 w-100">
                      ...
                      <select class="select-single-no-search form-select form-control" name="country" required>
