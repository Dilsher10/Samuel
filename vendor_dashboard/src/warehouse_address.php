...
if (isset($_POST['save'])) {
  ...
  $email = $_POST['email'];
    ...
    $sql = "INSERT INTO  warehouse_address (first_name,last_name,address,phone,country,state,email,token) VALUES ('" . $f_name . "','" .  $l_name . "','" . $address . "','" .  $phone . "','" . $country . "','" . $state . "','" . $email . "','" .  $_SESSION['token'] . "')";
